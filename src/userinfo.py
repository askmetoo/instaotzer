...
class UserInfo:
    ...
    url_user_id = "https://codeofaninja.com/tools/find-instagram-id-answer.php?instagram_username=%s"
    url_list = {
        "ink361": {
    ...
    def get_user_id_by_login(self, user_name):
        ...
        url_info = self.url_user_id % (user_name)
        info = self.s.get(url_info)
        #all_data = json.loads(info.text)
        #id_user = all_data['graphql']['user']['id']
        id_user = info.text.split("<b>")[1].split("</b>")[0]
        return id_user
